...
(defn communities-items [])

(views/defview featured-communities []
  (let [data [{:id                  constants/status-community-id
               :name                "Status"
              ...
              {:id             2
               :name           "NFT Kingdom"
               :description    "The one stop place to buy and sell your NFTs"
               :members        "27"
               :type           "token-gated"
               :section        "featured"
...
(views/defview categorized-communities []
  (let [data [{:id             constants/status-community-id
               :name           "Status"
               :description    "Status is a secure messaging app, crypto wallet and web3 browser built with the state of the art technology"
               :members        "27"
   ...
   [react/view {:padding-left 20}
    [react/view {:flex-direction      :row
     ...
     [quo2.text/text
      ...
      "Featured"]]
    [featured-communities communities-items]]
